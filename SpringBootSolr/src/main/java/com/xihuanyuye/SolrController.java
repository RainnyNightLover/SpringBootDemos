...
public class SolrController {
	...
	public String add() {
		...
		try {
			...
			client.add("xihuanyuye", doc);
			// client.commit();
			client.commit("xihuanyuye");
			return uuid;
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	public String delete(String id) {
		try {
			client.deleteById("xihuanyuye", id);
			client.commit("xihuanyuye");
	...
	public String deleteAll() {
		try {
			...
			client.deleteByQuery("xihuanyuye", "*:*");
			client.commit("xihuanyuye");
	...
	public String getById() throws Exception {
		SolrDocument document = client.getById("xihuanyuye", "3c6d011ee0c248b5bd6c4a0b16fdf668");
