...
import com.xihuanyuye.pagehelper.PageInfo;
import com.xihuanyuye.pagehelper.RowBounds;
import com.xihuanyuye.po.Ymq;
import com.xihuanyuye.run.Startup;
import com.xihuanyuye.utils.BaseSolr;
...
public class BaseTest {
    ...
    public void testAddCloudSolrClient() throws IOException, SolrServerException {
      ...
      /*  cloudSolrClient.setDefaultCollection("xihuanyuye");
	...
	/*    *//**
			 ...
			 * @throws Exception
			 *//*
				 * @Test public void testYmqSolrQuery() throws Exception {
				 * 
				 ...
				 * cloudSolrClient.connect(); QueryResponse response =
				 * cloudSolrClient.query(query);
				 * 
				 * List<Ymq> list = response.getBeans(Ymq.class);
				 * 
				 * for (Ymq item : list) { System.out.println("SolrQuery 语法查询响应 :" +
    ...
    public void testBaseSolrQuery() throws Exception {
        ...
        String ymqTitle = "penglei";
        String defaultCollection = "xihuanyuye";
